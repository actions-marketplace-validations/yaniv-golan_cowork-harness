...
Self-contained reference. Tracks `cowork-harness 1.19.0` (baseline `desktop-1.26832.0`).
...
release; pin an exact version (e.g. `version: "1.19.0"`) for reproducible CI.
...
```yaml
- run: npm i -g "cowork-harness@>=1.19.0"
