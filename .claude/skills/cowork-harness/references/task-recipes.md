...
Tracks `cowork-harness 1.21.0` (baseline `desktop-1.26832.0`), same as SKILL.md's front-matter. Recipe 2's `resolved-tier`/`unverifiable-tier` staleness classes and
