...
Tracks `cowork-harness 1.21.1` (baseline `desktop-1.28929.0`), same as SKILL.md's front-matter. Recipe 2's `resolved-tier`/`unverifiable-tier` staleness classes and
