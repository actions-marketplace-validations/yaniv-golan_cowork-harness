...
Tracks `cowork-harness 1.17.0` (baseline `desktop-1.24012.11`), same as SKILL.md's front-matter. Recipe 2's `resolved-tier`/`unverifiable-tier` staleness classes and
