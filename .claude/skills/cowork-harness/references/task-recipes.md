...
Tracks `cowork-harness 1.24.0` (baseline `desktop-1.32885.1`), same as SKILL.md's front-matter. Recipe 2's `resolved-tier`/`unverifiable-tier` staleness classes and
