...
Tracks `cowork-harness 1.22.0` (baseline `desktop-1.30096.1`), same as SKILL.md's front-matter. Recipe 2's `resolved-tier`/`unverifiable-tier` staleness classes and
