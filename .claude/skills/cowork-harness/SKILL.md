...
metadata:
  ...
  version: 1.17.0
  tracks-harness: cowork-harness 1.17.0 (baseline desktop-1.24012.11)
---
...
> `desktop-1.24012.11`). If your checkout is newer, prefer the live `--help` and — in a repo checkout —
