...
[docs/cli.md → Commands at a glance](./cli.md#commands-at-a-glance).
...
evidence; see [docs/cli.md → What you get out](./cli.md#what-you-get-out-inspectable-output) for the layout
...
- **`COWORK_HARNESS_DEBUG_SKILLHASH`** — when a cassette is flagged stale and you can't see why, this env
  ...
  source is one line. See [docs/cli.md → Reproducibility knobs](./cli.md#reproducibility-knobs).
