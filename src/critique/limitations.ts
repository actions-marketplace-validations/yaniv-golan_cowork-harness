...
export const CRITIQUE_LIMITATIONS: Limitation[] = [
  ...
  },
  {
    ...
    summary:
      "skill-authored content (SKILL.md, references/** and every agents/**.md the skill can dispatch) ships WHOLE up to a 512 KiB combined corpus ceiling; the transcript is bounded separately at 128 KiB with a head+tail cut and an elided middle",
    provenance: {
      kind: "deliberate",
      rationale:
